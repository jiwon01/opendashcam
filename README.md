...
기존 블랙박스 앱들의 레거시 구조와, 속도/시간 메타데이터가 영상에 충분히 삽입되지 않는 문제를 개선하기 위해 개발했습니다. 특히 시간 메타데이터를 영상에 명확히 포함해 사고 발생 시 증빙 활용도를 높이고, 실제 사용 환경을 고려해 디테일한 기능을 사용자가 ON/OFF 할 수 있도록 설계했습니다.  
